...
export SP_OBJECT_ID=$SP_OBJ_ID

# Azure AI Foundry endpoints
export FOUNDRY_TEST_ENDPOINT=$TEST_ENDPOINT
export FOUNDRY_PROD_ENDPOINT=$PROD_ENDPOINT

# Model deployment
export GPT_DEPLOYMENT=$GPT_DEPLOYMENT_NAME
